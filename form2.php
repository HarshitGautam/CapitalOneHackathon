    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="background:transparent !important">
            ...
            <div class="row">
				...
				<div class="col-lg-4">
    <form class="form-signin" action="baby.php" method="post">       
      <h2 class="form-signin-heading"></h2>
	  <input type="creditlimit" name='pass'class="form-control" name="creditlimit" placeholder="Credit Limit" required=""/>      
      <p><br></p>
	  <input type="pocketmoney" name='pass'class="form-control" name="pocketmoney" placeholder="Pocket Money" required=""/>
	  <p><br></p>
	  <input type="pocketmoney" name='pass'class="form-control" name="pocketmoney" placeholder="Pocket Money Cap" required=""/>
	  <p><br></p>
<div class="dropdown">
  <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    Pocket money timeperiod
  </button>
